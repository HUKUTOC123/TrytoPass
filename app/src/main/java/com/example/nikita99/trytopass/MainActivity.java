...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback, MapboxMap.OnMapClickListener, PermissionsListener {
        ...
        switch (item.getItemId()){
            case R.id.start:
                if(destinationPoint == null){
                    Toast.makeText(this, "Координаты конца не заданы", Toast.LENGTH_LONG).show();
                } else {
    ...
    public boolean onMapClick(@NonNull LatLng point) {
        ...
        addDistance(locationComponent.getLastKnownLocation().getLongitude(),
                locationComponent.getLastKnownLocation().getLatitude(),
                point.getLongitude(),
                point.getLatitude());
    ...
    private void addDistance(double startLat, double startLng, double endLat, double endLng){
        ...
        newDistance.setStartLat(startLat);
        newDistance.setStartLng(startLng);
        newDistance.setEndLat(endLat);
        newDistance.setEndLng(endLng);
        employeeDao.insert(newDistance);
    }
